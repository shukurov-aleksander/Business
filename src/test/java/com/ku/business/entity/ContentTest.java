...
public class ContentTest {
    ...
    public void testEqualsWhenIdNull() {
        ...
        Order firstOrder = new Order(1L, LocalDateTime.of(2022, 9, 19, 14, 5), LocalDateTime.of(2022, 9, 29, 14, 5), null, null);
        Order secondOrder = new Order(null, LocalDateTime.of(2022, 9, 19, 14, 5), null, null, null);
    ...
    public void testToStringWithCollections() {
        ...
        Service service = new Service(1L, "sell", 355L, "sell something");
        Order firstOrder = new Order(1L, LocalDateTime.of(2022, 9, 19, 14, 5), LocalDateTime.of(2022, 9, 29, 14, 5), null, null);
        Order secondOrder = new Order(2L, LocalDateTime.of(2022, 9, 19, 14, 5), null, null, null);
        List<Order> orders = new ArrayList<>();
        orders.add(firstOrder);
        orders.add(secondOrder);
