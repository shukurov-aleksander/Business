...
public class CompanyController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "500", content = @Content(schema = @Schema(example = "Some message 2"))),
            @ApiResponse(responseCode = "501", content = @Content(schema = @Schema(example = "Some message 3")))
    })
